...
<div class="h-screen">
    <div class="mx-10 my-4 flex justify-between items-center">
        <h1 class="text-xl font-bold">Create Training Course</h1>
    </div>
    ...
    <div class="mx-10 mt-4">
      <div class="flex justify-between gap-10 mb-4">
          <div class="w-full flex flex-col gap-2">
            ...
            <input name="codetrain" class="w-full" id="codetrain" type="text">
          </div>
          <div class="w-full flex flex-col gap-2">
            <label for="nametrain">Training Name ไม่เกิน (120 ตัวอักษร)</label>
            <input name="nametrain" class="w-full" id="nametrain" type="text">
          </div>
          <div class="w-full flex flex-col gap-2">
            <label for="daytrain">Many Day</label>
            <input name="daytrain" class="w-full" id="daytrain" type="number">
          </div>
      </div>
      ...
      <div class="flex justify-between gap-10 mb-4">
        <div class="w-full flex flex-col gap-2">
          ...
          <input name="feetrain" class="w-full" id="feetrain" type="number">
        </div>
        <div class="w-full flex flex-col gap-2">
          <label for="datetrain">Date training</label>
          <input name="datetrain" class="w-full" id="datetrain" type="date">
        </div>
        <div class="w-full flex flex-col gap-2">
