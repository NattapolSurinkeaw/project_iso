...
<div class="h-screen">
    <div class="mx-10 my-4 flex justify-between items-center">
        ...
        <a href="/backend/createnews" id="createnews" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</a>
    </div>
