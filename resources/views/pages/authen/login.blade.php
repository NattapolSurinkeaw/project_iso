    ...
    <div class="h-[94%] w-full bg-gradient-to-r from-sky-300 to-indigo-300 flex justify-center items-center">
        <div class="w-10/12 h-9/12 bg-white rounded-lg flex max-lg:flex-col">
            ...
            <div class="w-full rounded-r-lg flex flex-col justify-center items-center gap-5">
                <h1 class="m-4 text-xl font-normal tracking-tight text-gray-900 md:text-2xl dark:text-white">
                ...
                <div class="w-10/12">
                    <label for="password"
                        class="block mb-2 text-sm font-ligth text-gray-900 dark:text-white">Input Password</label>
