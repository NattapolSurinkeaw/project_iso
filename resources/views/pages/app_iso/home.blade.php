...
<div id="main">
  ...
  <div id="menu" class="w-10/12 mx-auto grid grid-cols-6 max-2xl:grid-cols-3 max-xs:grid-cols-2 gap-5 place-items-center mt-10">
    <a href="#signBoard">
      <div class="w-[239px] max-lg:w-[190px] max-xs:w-[155px] break-all flex max-lg:flex-col items-center max-xs:justify-center gap-2 border px-3 py-2 bg-gray-200 rounded-lg shadow-lg">
  ...
  <div class="flex flex-col gap-10 shadow-md rounded-lg p-4 w-10/12 mx-auto mt-10 mb-4 overflow-hidden">
  ...
  <div id="news"></div>
  <div class="flex flex-col gap-5 shadow-md rounded-lg p-4 w-10/12 mx-auto mt-10 mb-4">
  ...
  <div id="agencies"></div>
  <div class="flex flex-col gap-5 shadow-md rounded-lg p-4 w-10/12 mx-auto mt-10 mb-8">
